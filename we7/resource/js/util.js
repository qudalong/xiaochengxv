...
util.makeurl = function(e) {
   ...
   // e[2] && (a += "do=" + e[2] + "&")), t && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var r in t) r && t.hasOwnProperty(r) && t[r] && (a += r + "=" + t[r] + "&");
    ...
    console.log(i), console.log(a.data), null == r.siteInfo.siteroot || null == r.siteInfo.siteroot || i.indexOf("://") < 0 ? "function" == typeof a.fail && a.fail("网络请求失败,请刷新重试") : wx.request((_defineProperty(e = {
        url: i,
        data: a.data ? a.data : {},
